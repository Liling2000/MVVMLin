package com.jiyi.power.app.network

import com.jiyi.power.app.network.api.HomeService
import com.jiyi.power.app.utils.RetrofitClient
...
class HomeNetWork {
    ...
    private val mService by lazy { RetrofitClient.Companion.getInstance().create(HomeService::class.java) }
