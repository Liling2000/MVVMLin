...
import com.jiyi.power.ui.home.HomeListAdapter
import com.jiyi.power.ui.home.HomeViewModel
import com.jiyi.power.utils.GlideImageLoader
...
class HomeFragment : BaseFragment<HomeFragmentBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        with(mBinding.rvHome) {
            ...
            banner.minimumWidth = ViewGroup.LayoutParams.MATCH_PARENT
            banner.layoutParams =
                ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, resources.getDimension(R.dimen.dp_120).toInt())
